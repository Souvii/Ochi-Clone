...
function Footer() {
  return (
    <footer className='w-full h-screen bg-zinc-900 p-[5vw]  flex '>
      <div className='w-1/2 h-full flex flex-col justify-between'>
        <div className='headings'>
          <h1 className='text-[6vw] uppercase font-semibold leading-none -mb-[1vw]'>Eye-</h1>
          <h1 className='text-[6vw] uppercase font-semibold leading-none -mb-[1vw]'>Opening</h1>
        </div>
      ...
      <h1 className='text-[5vw] uppercase font-normal leading-none -mb-[1vw] pb-[5vw]'>presentations</h1>
      <div className="dets h-[1/2]">
        <div className="dets1 h-[1/2] flex flex-col mb-[12vw]">
        {["S:","Instagram","Behance","Fcebook","Linkdin","hello"].map((item,index)=>(
                                        <a key={index} className={`text-lg font-semibold gap-1`}>{item}</a>
                                    ))}
     <div className="dets2 flex h-[1/2] flex-col gap-1 mb-[5vw]">
